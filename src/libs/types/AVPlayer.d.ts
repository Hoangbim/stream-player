...
import WebSocketIOLoader, { WebSocketOptions } from "@libmedia/avnetwork/ioLoader/WebSocketIOLoader";
...
export default class AVPlayer extends Emitter implements ControllerObserver {
    ...
    static Util: {
        ...
        browser: import("@libmedia/common/types/type").Browser;
        os: import("@libmedia/common/types/type").OS;
    };
    static IOLoader: {
     ...
     * @returns
     */
    getChapters(): import("@libmedia/avformat/AVFormatContext").AVChapter[];
    /**
     * 获取总时长（毫秒）
     *
     * @returns
